            ...
            <div class="container py-5">
                <div class="row mb-4 mb-lg-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h1 class="display-1 fw-bold" style="color: rgb(0,192,163);">Login</h1>
                        <h2 class="fw-bold">Welcome back to your fitness journey - log in and let's get moving!</h2>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body text-center d-flex flex-column align-items-center">
                                ...
                                <form action="process_login.php" method="post">
                                    ...
                                    <a href="forget_password.php"><p class="text-muted">Forgot your password?</p></a>
                                </form>
                            </div>
                        </div>
                    </div>
