            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <h1 class="display-5 fw-bold text-start d-xxl-flex align-items-xxl-center" style="color: rgb(0,192,163);padding-right: 0px;">Register</h1>
                        <h2 class="display-5 fw-bold text-start" style="padding-right: 0px;font-size: 23px;">Join the fitness revolution today and register for a healthier tomorrow</h2>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body text-center d-flex flex-column align-items-center">
                                ...
                                <form action="process_register.php" method="post">
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary shadow d-block w-100" type="submit">Register</button></div>
