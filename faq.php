        ...
        <section class="py-5">
            <div class="row mb-5" style="margin-top: -30px;">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h1 class="display-5 fw-bold" style="color: rgb(0,192,163);">FAQs</h1>
                    <h2 class="fw-bold" style="font-size: 23px;">Your questions answered - discover anything you need to know to kick-start your fitness journey</h2>
                </div>
            </div>
            <div class="container">
                <div class="accordion" role="tablist" id="accordion-1">
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-collapse collapse item-2" role="tabpanel" data-bs-parent="#accordion-1">
                            <div class="accordion-body">
                                <p class="mb-0">We currently have 2 outlets, one at Kallang (Kallang Wave Mall), and Bishan (Bishan Community Club).&nbsp;</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div class="accordion-collapse collapse item-3" role="tabpanel" data-bs-parent="#accordion-1">
                            <div class="accordion-body">
                                <p class="mb-0">No, it is not compulsory to register for an account before you can make any booking. However, one must successfully make payment for any one of our membership plans before any booking can be done.&nbsp;</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-collapse collapse item-5" role="tabpanel" data-bs-parent="#accordion-1">
                            <div class="accordion-body">
                                <p class="mb-0">Yes! We do have locker rooms, as well as personal showers available!</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
