            ...
            <div class="row g-0 row-cols-1 row-cols-md-2 row-cols-xl-3 d-flex align-items-md-center align-items-xl-center">
                ...
                <div class="col-md-6 col-xxl-5 mb-4">
                    <div class="card text-white bg-primary">
                        <div class="card-body p-4" style="width: 348px;margin-left: -10px;">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 class="fw-bold text-white mb-0" style="margin-right: 26px;">Premium</h3>
                                    <p style="margin-bottom: 3px;">(Open Gym + Special Benefits)</p><span class="badge rounded-pill bg-primary text-uppercase fs-6 bg-semi-white">Best Value</span>
                                    <h4 class="display-4 fw-bold text-white" style="margin-top: 3px;">Coming Soon</h4>
                                </div>
                                <div></div>
                            </div>
                            <div>
